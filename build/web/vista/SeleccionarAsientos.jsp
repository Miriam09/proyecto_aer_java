...
//    ArrayList asientosVuelta = new ArrayList();
//        for (int a = 1; a <= arrayOcupacionVuelta.size(); a++) {
//            if (a == 1) {
...
//        }
    ...
    session.setAttribute("PasajerosElegir", arrayElegir);
    ArrayList asientosIda = (ArrayList) session.getAttribute("totalAsientosIda");
    ArrayList asientosOcupados = (ArrayList) session.getAttribute("asientosOcupadosIda");
    ArrayList asientosLibres = (ArrayList) session.getAttribute("asientosLibresIda");
//    boolean irSelAsVuelta = (boolean) session.getAttribute("seleccionAsientosVuelta");
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-9">
                        <form  role="form" id="formularioPasajeros" action="/NavisLines/ServletRecogerAsientos">
                            <h3>Eleccion Asientos Vuelo Ida</h3>
