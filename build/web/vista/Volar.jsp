            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <br/><br/><br/>
                        <div class="well">
                            <form  role="form" name="Pagar" id="Pagar" action="/NavisLines/ServletVolar">
                                <div class="row ">
                                    <div class="col-md-2"></div>
                                    <div class="col-md-2"><small>Numero Vuelo</small></div>
                                    <div class="col-md-4"><input type="text" class="form-control" id="numVuelo" name="numVuelo" required></div>
                                    <hr>
                                </div>
                                <br/>
                                <div class="row">
                                    <div class="col-md-2"></div>
                                    <div class="col-md-2"><small>Fecha Vuelo</small></div>
                                    <div class="col-md-4">
                                        <div class="input-group date" data-provide="datepicker">
                                            <input  name="fechaVuelo" class="form-control ui-selectmenu-text" data-date-format="yyyy-mm-dd"  id="fechaVuelo" >
                                        </div>
                                    </div>
                                </div>
                                <br/>
                                <button type="submit" class="btn center-block botonVolar" id="botonSiguiente" ></button>
                            </form>
                        </div>
                    </div>
                    <div class="col-md-3">
