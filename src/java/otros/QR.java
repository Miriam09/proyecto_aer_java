...
public class QR {
    ...
    // Let's do it
    public static void createCode(String data, int qr) throws Exception {
        ...
        String IMG_PATH = "C:/Users/Miriam/Documents/NetBeansProjects/NavisLines/web/images/QR/QR" + qr + ".png";
