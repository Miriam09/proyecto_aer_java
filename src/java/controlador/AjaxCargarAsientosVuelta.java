 ...
 * @author Miriam
 */
public class AjaxCargarAsientosVuelta extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList asientosOcupados = (ArrayList) SessionOcupacionesVuelta.getAttribute("asientosOcupadosVuelta");
            ArrayList asientosLibres = (ArrayList) SessionOcupacionesVuelta.getAttribute("asientosLibresVuelta");
