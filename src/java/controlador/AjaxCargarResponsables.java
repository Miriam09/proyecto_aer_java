 ...
 * @author Miriam
 */
public class AjaxCargarResponsables extends HttpServlet {
private Connection conexion;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AjaxCargarResponsables</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AjaxCargarResponsables at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
